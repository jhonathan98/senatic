...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        } elseif ($accion === 'activar_usuario') {
            // Aquí podrías agregar un campo 'activo' a la tabla usuarios
            $mensaje = "Usuario activado.";
            $tipo_mensaje = 'success';
        } elseif ($accion === 'desactivar_usuario') {
            // Aquí podrías agregar un campo 'activo' a la tabla usuarios
...
<head>
    ...
    <title>Gestión de Usuarios - Student News</title>
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-9">
                                                            ...
                                                            <p class="mb-2"><strong>Artículos publicados:</strong> <?= $usuario['total_articulos'] ?></p>
                                                        </div>
                                                    </div>
